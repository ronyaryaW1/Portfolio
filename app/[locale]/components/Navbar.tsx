	...
	return (
		<>
			...
			<nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScrolled ? ' bg-white/50 backdrop-blur-md shadow-sm dark:bg-darkTheme dark:shadow-white/20' : ''}`}>
				...
				<ul
					ref={sideMenuRef}
					className='flex md:hidden flex-col gap-4 px-10 py-20 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-slate-50 transition duration-500 dark:bg-darkTheme dark:text-white'
				>
					<div
