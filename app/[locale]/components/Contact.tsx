			...
			>
				<div className='grid md:grid-cols-2 sm:grid-cols-1 gap-6 mt-10 mb-8'>
					<input
						...
						required
						className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-darkCardSecondary dark:border-white/90'
					/>
					<input
						type='email'
						name='email'
				...
				<textarea
					...
					name='message'
					required
					className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6 w-full dark:bg-darkCardSecondary dark:border-white/90'
				></textarea>
