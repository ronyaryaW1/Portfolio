			...
			<motion.div className='flex w-full flex-col lg:flex-row items-center gap-20 '>
				...
				>
					<p className='mb-10 max-w-2xl font-Ovo'>
						I am a Frontend Developer with 4 years of experience building high-performance web applications using React.js and mobile applications with React Native. Passionate about crafting engaging UI/UX, I have a good
